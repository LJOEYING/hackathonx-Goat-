      ...
      child: TextField(
        decoration: InputDecoration(
          ...
          border: OutlineInputBorder(
            ...
            borderSide:
                BorderSide.none, // Remove the border to match the container
          ),
          filled: true, // This ensures that the background color is applied
          fillColor: Colors.black, // Set the fill color for the TextField
        ),
      ),
    );
  }
...
class CollectionTypeSelector extends StatelessWidget {
  final items = [
    ...
    {
      'label':
          'Mobile Recycling Centres', //label for the mobile recycling centre option
    ...
    return Container(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final color =
              items[index]['color']! as Color; // get the background color
          return _buildCollectionIcon(
              label, photo, color); // build the icon for the item
        },
      ),
    );
  }
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color:
                color, //set the background color for the waste collection type
